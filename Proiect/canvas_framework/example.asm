...
colorO EQU 0ffffffh ; culoare 0
colorLines EQU 08585adh ; culoare linii
colorW EQU 0ff3300h ; culoare linie victorie
colorF EQU 0ffffh ; fundal
...
second_diagonal macro x, y, len, color 
local firstLoop, salt
...
position macro x, y
local finalX, finalY, saltX1, saltX2, saltY1, saltY2, saltCmpBox, reset_1, resetF, final
...
;;determin coloana pe care ma aflu
	...
	reset
	;make_text_macro 'R', area, area_width / 2 - 200, 5
...
winX macro
	...
	make_text_macro 'C', area, area_width / 2 - 100, 5
	make_text_macro 'A', area, area_width / 2 - 90, 5
	make_text_macro 'S', area, area_width / 2 - 80, 5
	make_text_macro 'T', area, area_width / 2 - 70, 5
	make_text_macro 'I', area, area_width / 2 - 60, 5
	make_text_macro 'G', area, area_width / 2 - 50, 5
	make_text_macro 'A', area, area_width / 2 - 40, 5
	make_text_macro 'T', area, area_width / 2 - 30, 5
	make_text_macro 'O', area, area_width / 2 - 20, 5
	make_text_macro 'R', area, area_width / 2 - 10, 5
	make_text_macro 'U', area, area_width / 2, 5
	make_text_macro 'L', area, area_width / 2 + 10, 5
	make_text_macro ' ', area, area_width / 2 + 20, 5
	make_text_macro 'E', area, area_width / 2 + 30, 5
	make_text_macro 'S', area, area_width / 2 + 40, 5
	make_text_macro 'T', area, area_width / 2 + 50, 5
	make_text_macro 'E', area, area_width / 2 + 60, 5
	make_text_macro ' ', area, area_width / 2 + 70, 5
	make_text_macro 'X', area, area_width / 2 + 80, 5
endm
...
win0 macro
	...
	make_text_macro 'E', area, area_width / 2 + 60, 5
	make_text_macro ' ', area, area_width / 2 + 70, 5
	make_text_macro '0', area, area_width / 2 + 80, 5
endm

remiza macro

	make_text_macro ' ', area, area_width / 2 - 90, 5
	make_text_macro ' ', area, area_width / 2 - 80, 5
	make_text_macro ' ', area, area_width / 2 - 70, 5
	make_text_macro ' ', area, area_width / 2 - 60, 5
	make_text_macro ' ', area, area_width / 2 - 50, 5
	make_text_macro 'R', area, area_width / 2 - 40, 5
	make_text_macro 'E', area, area_width / 2 - 30, 5
	make_text_macro 'M', area, area_width / 2 - 20, 5
	make_text_macro 'I', area, area_width / 2 - 10, 5
	make_text_macro 'Z', area, area_width / 2, 5
	make_text_macro 'A', area, area_width / 2 + 10, 5
	make_text_macro ' ', area, area_width / 2 + 20, 5
	make_text_macro ' ', area, area_width / 2 + 30, 5
	make_text_macro ' ', area, area_width / 2 + 40, 5
	make_text_macro ' ', area, area_width / 2 + 50, 5
	make_text_macro ' ', area, area_width / 2 + 60, 5
	make_text_macro ' ', area, area_width / 2 + 70, 5
	make_text_macro ' ', area, area_width / 2 + 80, 5
...
local final, salt_1, salt_2, salt_3, salt_4, salt_5, salt_6, salt_7, salt_8, salt_9, salt_10, salt_10, salt_11, salt_12, salt_13, salt_14, salt_15, salt_16
	...
	win0
	second_diagonal area_width - 45, 52, area_width * 2 / 3 - 10, colorW
	mov cnt, 10
	jmp final
...
afisare_litere:
	...
	vertical_line area_width - 80, 5, 30, colorLines
	horizontal_line area_width - 80, 35, 70, colorLines
	make_text_macro 'R', area, area_width - 75, 10
	make_text_macro 'E', area, area_width - 65, 10
	make_text_macro 'S', area, area_width - 55, 10
	make_text_macro 'E', area, area_width - 45, 10
	make_text_macro 'T', area, area_width - 35, 10
